...
impl Cycle<MyCellType> for OwnCycle {
    fn update_cycle(
        ...
        let relative_division_food_level = ((c.get_intracellular()[1]
            - c.cycle.food_division_threshold)
            / (c.cellular_reactions
...
impl CellularReactions<ReactionVector> for OwnReactions {
    fn calculate_intra_and_extracellular_reaction_increment(
        ...
        increment_extracellular[3] =
            self.p4 / (1.0 + self.bmp4_hill * bmp4) - self.p3 * a.powf(2.0) * b;
