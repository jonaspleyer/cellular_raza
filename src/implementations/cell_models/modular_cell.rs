...
macro_rules! define_no_cellular_reactions{
    ($conc_vec_intracellular:ty, $conc_vec_extracellular:ty) => {
        ...
        impl<Mec, Int, Cyc, IntExtracellular> CellularReactions<$conc_vec_intracellular, $conc_vec_extracellular> for ModularCell<Mec, Int, Cyc, NoCellularreactions, IntExtracellular>
        where
...
impl<Pos, For, Vel, Mec, Int, Cyc, React, IntExtracellular> Mechanics<Pos, For, Vel> for ModularCell<Mec, Int, Cyc, React, IntExtracellular>
where
...
impl<Pos, For, Inf, Mec, Int, Cyc, React, IntExtracellular> Interaction<Pos, For, Inf> for ModularCell<Mec, Int, Cyc, React, IntExtracellular>
where
    Pos: Position,
    For: Force,
...
impl<Mec, Int, Cyc, React, IntExtracellular> Cycle<Self> for ModularCell<Mec, Int, Cyc, React, IntExtracellular>
where
    Cyc: Cycle<Self>,
{
