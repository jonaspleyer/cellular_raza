...
/// Generated by the [decompose](Domain::decompose) method. The backend will know how to deal with this type
/// and crate a working simulation from it.
pub struct DecomposedDomain<I, S, C> {
    /// Number of spawned [SubDomains](SubDomain). This number is guaranteed to be smaller or equal to the
