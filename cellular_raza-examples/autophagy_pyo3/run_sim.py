...
simulation_settings.particle_template_cargo.interaction.clustering_strength = 1.5
simulation_settings.particle_template_cargo.mechanics.diffusion_constant = 0.000001
simulation_settings.particle_template_cargo.mechanics.kb_temperature = 0.1
...
simulation_settings.particle_template_atg11_receptor.interaction.clustering_strength = 1
simulation_settings.particle_template_atg11_receptor.mechanics.diffusion_constant = 0.00001
simulation_settings.particle_template_atg11_receptor.mechanics.kb_temperature = 0.001
