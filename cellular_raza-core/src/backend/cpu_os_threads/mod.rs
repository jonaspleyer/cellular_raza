...
///
/// There is one main error type [SimulationError](errors::SimulationError) which should be
/// derivable from errors arising during the simulation process.
...
///   [RevertChangeAccuracy](errors::HandlingStrategies::RevertChangeAccuracy) |
/// | CalcError | Solver Accuracy, Bug by user implementation of corresponding function,
